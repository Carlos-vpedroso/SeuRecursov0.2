...
const GerarPdf = async ({
  ...
  function Body(dadosRecurso: any): Content[] {
    if (dadosRecurso.notificado === "NÃO") {
        ...
        return [
...

          {
            text: [
              "Auto de Infração",
              {
                text: ` ${dadosUsuario.autoInfracao}`,
          ...
          },
          {
            text: [
              ...
              ", vem respeitosamente a presença de Vossa Senhoria, com fundamento na Constituição da República, Lei 9.503/97 e demais dispositivos aplicáveis à espécie, interpor a presente:",
            ],
            style: "paragrafos",
          },
          ...
          {
            text: "Em face da penalidade aplicada irregularmente conforme será demonstrado, sem obedecer às delimitações estabelecidas pelo CONTRAN.",
            style: "paragrafos",
          },
          ...
          {
            text: "O presente recurso é tempestivo, eis que segue o prazo previsto no auto de infração em anexo, e em razão ao posicionamento unânime dos Tribunais Superiores, “que o decurso do tempo não convalida o que nasceu invalido.” Segue:",
            style: "paragrafos",
          },
          ...
          {
            text: "Tal infração, não merece ser mantida, já que ao longo de toda a minha trajetória como condutor, sempre respeitei e zelei pelas normas de trânsito.",
            style: "paragrafos",
          },

          {
            text: "Além disso, o auto de infração imposto contém inúmeras irregularidades e vícios insanáveis, além de ausência de informações imprescindíveis, conforme será demonstrado a seguir.",
            style: "paragrafos",
          },

          {
            text: "Portanto, o recurso interposto busca a anulação do presente auto de infração, e seu consequente arquivamento, evitando assim, a aplicação da penalidade de forma injusta.",
            style: "paragrafos",
          },
          ...
          {
            text: "A Constituição Federal, em seu artigo 37, discorre acerca dos princípios básicos da Administração Pública, que são: Legalidade, impessoalidade, moralidade, publicidade e eficiência.",
            style: "paragrafos",
          },

          {
            text: 'O princípio da legalidade na administração pública implica que ela está vinculada estritamente à lei, agindo somente dentro dos limites estabelecidos e de acordo com os procedimentos legais prescritos. Isso reflete a ideia do "império da lei" sobre a vontade arbitrária dos indivíduos.',
            style: "paragrafos",
          },

          {
            text: "Já a impessoalidade procura evitar que agentes públicos ajam visando interesses pessoais, garantindo que suas ações sejam guiadas pelo bem comum, em vez de preferências individuais, evitando assim desvios de finalidade ou abusos de poder.",
            style: "paragrafos",
          },

          {
            text: "O princípio da moralidade refere-se à conduta ética e honesta, alinhada com o interesse público, diferenciando-se da moral individual. Ele complementa o princípio da legalidade, exigindo que os agentes públicos considerem não apenas a legalidade formal, mas também a moralidade em suas decisões.",
            style: "paragrafos",
          },

          {
            text: "A publicidade na administração pública implica que seus atos e decisões devem ser transparentes e acessíveis ao conhecimento público, evitando segredos ou sigilos que possam prejudicar os interesses individuais ou coletivos.",
            style: "paragrafos",
          },

          {
            text: "Por fim, a eficiência na administração pública diz respeito à otimização dos recursos e ações, visando a redução de erros e a obtenção dos melhores resultados possíveis, embora esse conceito possa ser interpretado de várias maneiras e, por vezes, restrito a uma visão muito específica.",
            style: "paragrafos",
          },

          {
            text: "Portanto, fica claro que é obrigatório à Administração Pública, o cumprimento destes princípios BÁSICOS acima expostos, para que haja a regularidade da infração e o cumprimento da aplicação da penalidade. No caso a seguir, podemos observar que há a inobservância de tais princípios, merecendo assim a anulação do presente auto.",
            style: "paragrafos",
          },
          ...
          {
            text: "O auto de infração é um documento público, lavrado pelo agente de trânsito no momento em que constata a ocorrência da infração. Trata-se de um documento de suma importância, pois ele é necessário para instauração do processo administrativo de trânsito, conforme dispõe o artigo 280 do Código de Trânsito Brasileiro.",
            style: "paragrafos",
          },

          {
            text: "Somente através do processo administrativo, com a observância dos princípios do contraditório e da ampla defesa, que é possível imputar ao condutor a prática de alguma infração e aplicar a penalidade devida.",
            style: "paragrafos",
          },
          ...
          {
            text: "E é nesse ponto que exsurge o vício presente no auto de infração aqui impugnado. A simples leitura do documento em questão mostra que o policial responsável por sua lavratura apenas assinalou a opção que indicava a suposta infração.",
            style: "paragrafos",
          },
...

          {
            ul: [
              ...
              {
                text: "NÃO FOI DADA CÓPIA DO AIT AO RECORRENTE PELO AGENTE",
                bold: true,
              },
              {
                text: "DESCARACTERIZAÇÃO E NULIDADE ABSOLUTA DO AIT",
                bold: true,
              },
            ],
            margin: [150, 10, 0, 0],
          ...
          {
            text: "Analisando o artigo de lei da infração imposta, conclui-se que é indispensável o cumprimento de medida administrativa, aliado com imposição de penalidade aplicado pelo agente policial.",
            style: "paragrafos",
          },

          {
            text: [
              "Fica clara a ",
              { text: "OMISSÃO", bold: true },
              " do agente que lavrou o auto de infração, o fazendo de forma arbitrária, uma vez que se omitiu e não aplicou a medida administrativa imposta pelo artigo que tipificou a infração, já que não houve o cumprimento de medida administrativo. Desta forma como há a possibilidade de dar credibilidade a tal autuação, se em sua lavratura não há um mínimo de regularidade para sua aplicação?",
            ],
            style: "paragrafos",
          },

          {
            text: "Todavia, o Código de Trânsito Brasileiro que instituiu o Sistema Nacional de Trânsito, teve como fundamento a diminuição no cometimento das infrações de trânsito, bem como incentivar à sua educação. Tais medidas devem ser atreladas às possíveis sanções para quem demandar contrariamente às determinações legais.",
            style: "paragrafos",
          },

          {
            text: "Portanto, é um conjunto punitivo que trará ao condutor infrator a pretensão de não cometer novas infrações, educando-o.",
            style: "paragrafos",
          },

          {
            text: "Neste diapasão, gostaria que observasse o que determina o art. 161 do CTB:",
            style: "paragrafos",
          },

          {
            text: "Art. 161 - Constitui infração de trânsito a inobservância de qualquer preceito deste Código, da legislação complementar ou das resoluções do CONTRAN, sendo o infrator sujeito às penalidades e medidas administrativas indicadas em cada artigo, além das punições previstas no Capítulo XIX.",
            style: "alinhadoDireita",
          },

          {
            text: "Logo, depreende-se de que no momento da aplicação da medida punitiva, não se poderá deixar esta ou aquela determinação para cumprimento ao bom senso do agente autuador, mas sim, deverá ser aplicada como está expressa de forma positivada em cada um dos artigos da lei. Desta forma, se o agente, ao praticar ato administrativo de sua competência, fazê-lo ao arrepio do que determina a lei, este ato todo está eivado de vícios e passível de anulabilidade.",
            style: "paragrafos",
          },

          {
            text: "Portanto, não é outra a determinação daquele códex, senão:",
            style: "alinhadoDireita",
          },
          ...
          {
            text: "Também, reforçando tal interpretação:",
            style: "alinhadoDireita",
          },

          {
            text: "Art. 24 - Compete aos órgãos e entidades executivos de trânsito dos Municípios, no âmbito de sua circunscrição: ",
            style: "alinhadoDireita",
          },

          {
            text: "I - cumprir e fazer cumprir a legislação e as normas de trânsito, no âmbito de suas atribuições;",
            style: "alinhadoDireita",
          },

          {
            text: "Portanto, é justo vir perante Vs. Senhoria, expor o contraditório a autuação e requerer a declaração de nulidade da mesma.",
            style: "paragrafos",
          },

          {
            text: [
              "O que se vê é uma clara arbitrariedade do agente, e uma grande irresponsabilidade no exercício de sua relevante função. A falta de informações decorre, na realidade, da inexistência de qualquer infração. Por fim, ressalte-se que não houve o cumprimento de medida administrativa",
              { text: "OBRIGATÓRIA.", bold: true },
            ],
            style: "paragrafos",
          },
          ...
          {
            text: "Inicialmente, é preciso esclarecer, a presente notificação é nula, de pleno direito, eis que o Código de Trânsito traz a seguinte determinação:",
            style: "paragrafos",
          },
          ...
          {
            text: "E é nesse sentido que se orienta a interpretação que deve ser dada ao artigo 280 do Código de Trânsito Brasileiro, quando em seu inciso I exige a “tipificação da infração” como elemento essencial do auto de infração.",
            style: "paragrafos",
          },

          {
            text: [
              "Essa interpretação é ainda reforçada pelo ",
              { text: "DENATRAN", bold: true },
              "(Departamento Nacional de Trânsito), que acertadamente editou a Resolução 390/11, dispondo sobre os procedimentos administrativos necessários para lavratura do auto de infração. O artigo 3º da referida Resolução assim prescreve:",
            ],
            style: "paragrafos",
          },
          ...
          {
            text: "Excelentíssimo julgador, de que forma os dados inseridos no auto de infração, cuja cópia se encontra em anexo, auxiliam a compreensão da ocorrência? Onde estão os elementos que motivaram a autuação? Como pode o agente afirmar com exatidão a conduta descrita, se nem mesmo preencheu de forma correta o auto de infração?",
            style: "paragrafos",
          },

          {
            text: "Ora Ilustríssimo julgador, como pode o recorrente se defender dignamente de tal autuação, lavrada de forma tão genérica? Não há controvérsias frente a tal fato. A omissão do agente que lavrou o auto de infração, feriu os direitos constitucionais e da  ampla defesa e ao contraditório, assim prejudicando o devido processo legal.",
            style: "paragrafos",
          },

          {
            text: "Tal afronta a vida pregressa do recorrente é penalidade sem intuito educativo, apenas ensejando penalizar por conduta incerta e incoerente. Frente a tal fato, não há que se falar em deferir tal penalização obscura.",
            style: "paragrafos",
          },

          {
            text: "O que se vê é uma clara arbitrariedade do agente e uma grande irresponsabilidade no exercício de sua relevante função. A falta de informações decorre, na realidade, da inexistência de qualquer infração. O condutor é motorista de longa data e responsável, que sempre dirigiu com prudência e cautela, cumprindo com afinco todos os ditames legais. É claro que, assim como todo ser humano, pode cometer erros, mas não pode concordar em assumir a responsabilidade por algo que não fez.",
            style: "paragrafos",
          },

          {
            text: "Todo o exposto revela que se trata de um Auto de Infração irregular e inepto, que obstaculizou o exercício do direito de defesa da recorrente. A falta de elementos concretos para caracterização da infração reforça ainda mais sua inconsistência. Nesses casos, o artigo 281, parágrafo único, inciso I, do Código de trânsito Brasileiro nos apresenta o único desfecho possível, que é seu imediato arquivamento.",
            style: "paragrafosBold",
          },

          {
            text: "O Supremo Tribunal Federal já pacificou matéria quanto à possibilidade da Administração Pública anular os seus atos eivados de nulidades, conforme a Súmula nº 473, transcrita a seguir:",
            style: "paragrafos",
          },
      ...
      return [
...

        {
          text: [
            "Auto de Infração",
            { text: ` ${dadosUsuario.autoInfracao}`, style: "dadosVariaveis" },
          ],
          style: "paragrafos",
        },
        {
  ...
  function Rodape(currentPage: any, pageCount: any): Content[] {
    return [
      {
